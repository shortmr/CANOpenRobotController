...
void Calibration::during(void) {
    if(stages == 1){
        ...
        tau = robot->getJointTor_s(); // TODO: change to motor torque monitoring (see MultiM1Machine)
        JointVec dq_t;
        dq_t(0) = cal_velocity;
    ...
    {
        // Stage 2: Force Sensor Zeroing (calibration) TODO: change based on m1_params.yaml
